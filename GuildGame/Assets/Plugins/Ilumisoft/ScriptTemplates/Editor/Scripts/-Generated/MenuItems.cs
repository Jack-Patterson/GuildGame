namespace Ilumisoft.ScriptTemplates
{
	...
	public class TemplateMenuItems : MonoBehaviour 
	{
		...
		[MenuItem("Assets/Create/C# Script From Template/MonoBehaviourTest", priority = 81)]
		static void MenuItem5()
		{
			ScriptFactory.CreateScriptFromTemplateAsset("Assets/Plugins/Ilumisoft/ScriptTemplates/Editor/Templates/Scripts/MonoBehaviourTest.txt","MonoBehaviourTest");
		}
		...
		[MenuItem("Assets/Create/C# Script From Template/Singleton", priority = 81)]
		static void MenuItem7()
		{
			ScriptFactory.CreateScriptFromTemplateAsset("Assets/Plugins/Ilumisoft/ScriptTemplates/Editor/Templates/Scripts/Singleton.txt","Singleton");
		}
		
		[MenuItem("Assets/Create/C# Script From Template/Struct", priority = 81)]
		static void MenuItem8()
		{
